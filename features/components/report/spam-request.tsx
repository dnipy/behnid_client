...
function SpamRequest(props : {id : number ,openState : boolean , setOpenState : React.Dispatch<React.SetStateAction<boolean>>}) {
        ...
        <div className="flex h-[79vh] mt-[4.5rem]  justify-center items-center">                         
            <div className={`w-[330px] ${'h-[600px]'}  flex flex-col items-center justify-center bg-beh-gray rounded-3xl `}>
                <div className='h-[95%] w-full'>
                    {/* top */}
                    <h1 className="text-center text-2xl  font-bold text-white/80 mb-4">گزارش درخواست</h1>

...
function SpamProduct(props : {openState : boolean , setOpenState : React.Dispatch<React.SetStateAction<boolean>>}) {
        ...
        <div className="flex h-[79vh] mt-[4.5rem]  justify-center items-center">                         
            <div className={`w-[330px] ${'h-[600px]'}  flex flex-col items-center justify-center bg-beh-gray rounded-3xl `}>
                <div className='h-[95%] w-full'>
                    {/* top */}
                    <h1 className="text-center text-2xl  font-bold text-white/80 mb-4">گزارش محصول</h1>
                    ...
                    <div className="w-full p-2 h-[80px] gap-x-2  flex justify-around items-center">
                              <div onClick={selectedItem && !loading ? ()=> handleSend() : undefined}  className={`w-[50%]  h-[50px] rounded-xl ${ selectedItem ? 'bg-beh-green-light cursor-pointer' : 'bg-beh-green-super-light/25 cursor-not-allowed '  }   flex justify-center items-center`}>

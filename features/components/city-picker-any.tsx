...
export const CityPickerModel = (props : { fildes : any , setFileds :React.Dispatch<React.SetStateAction<any>>  })=>{
                                            ...
                                            <div dir="rtl" onClick={()=>setOpenedCity(elm.id)} className="w-[70%]  hover:text-beh-orange duration-100 mx-auto rounded-md my-2  px-5  ">
                                                {
                                                    elm.cities.map(city=>(
                                                            ...
                                                            <div key={city.id} onClick={()=>setFileds({...fildes, send_from :city.id ,city_id : city.id , showCityPicker : false , selectedCityName : city.name})} className="w-[90%] hover:text-beh-orange text-beh-gray duration-100 mx-auto rounded-md h-10 my-2 bg-beh-gray-light flex justify-center items-center px-5  gap-5">
...
export const CityPickerModelForProfile = (props : { setFields : Dispatch<SetStateAction<{isOpened: boolean ,  city_name: string }>> , fields : { isOpened: boolean, city_name: string; } , handleSubmit: (cityID: number) => Promise<void>  })=>{
    const [error,setError] = useState('')
                ...
                <div dir='rtl' className='w-[380px]  md:w-[600px] min-w-[370px]  mx-auto h-[70vh]  bg-white rounded-3xl overflow-y-auto  '>
                    <div>
                        <div className="flex justify-between h-[60px] my-2 gap-5 items-center">
                            ...
                            <div>
                                <h1 onClick={()=>setFields({...fields , isOpened : false})} className="pl-7 text-xl font-bold text-beh-orange">
                                    انصراف
                                </h1>
                            </div>
                                            ...
                                            <div dir="rtl" onClick={()=>setOpenedCity(elm.id)} className="w-[70%]  hover:text-beh-orange duration-100 mx-auto rounded-md my-2  px-5  ">
                                                {
                                                    elm.cities.map(city=>(
                                                            ...
                                                            <div key={city.id} onClick={()=>{
                                                                props.handleSubmit(city.id).then(()=>{
                                                                    setFields({
                                                                        city_name : city.name,
                                                                        isOpened : false
                                                                    })

...
function IndexStoryBar() {
    ...
    const router = useRouter()
        return (
            <>
          <div dir='rtl' className='rounded-sm h-14  mt-5 pt-3  w-full overflow-auto min-h-[1rem] bg-[#2C2C2C]  border-t-solid border-orange-500 border-t-[4px] flex' >
              {/* <StroyComponent/>
              <StroyComponent/>
              <StroyComponent/>
              <StroyComponent/>
              <StroyComponent/>
              <StroyComponent/> */}
               <div className="absolute left-1/2 xl:left-1/2  px-12 py-2 rounded-full bg-white border-4 border-beh-orange -translate-x-1/2 ssss:bg-gray-900 ">

        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <div onClick={ isUser() ? ()=> dispatch(OpenAndClose()) : undefined} >
                ...
                {/* <span className="sr-only">Open user menu</span> */}
                {
                    ...
                    {
                        response?.avatar  ? 
                            <img className="h-8 w-8 rounded-full" src={response?.avatar ? `${BACK_END}${response.avatar}` : "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"} alt="user-account"/>
                            :

  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            {selector.value ? 
                <div dir='rtl' className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" >
                    <p onClick={()=> router.replace('/profile')}   className="block px-4 py-2 text-sm text-gray-700   text-center" role="menuitem"  id="user-menu-item-0">مشاهده پروفایل</p><br></br>
                    <p onClick={()=> router.replace('/profile/change-detaile')}  className="block px-4 py-2 text-sm text-center text-gray-700" role="menuitem"  id="user-menu-item-1">تنظیمات پروفایل</p><br></br>
                    <p onClick={()=> router.replace('/auth/logout')}  className="block px-4 py-2 text-sm text-gray-700 text-center" role="menuitem"  id="user-menu-item-2">خروج</p><br></br>
                </div> :
                null
            }
            </div>

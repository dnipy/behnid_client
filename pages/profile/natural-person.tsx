...
function FirstStep() {
    ...
    const handleSend = async()=>{
      ...
      if(file?.item(0) && file2?.item(0) ){
          body.append('person_1',file.item(0) as Blob)
          body.append('person_2',file2.item(0) as Blob)
          body.append('person_3',file3?.item(0) as Blob)
          body.append('person_4',file4?.item(0) as Blob)

      
          AuthorizedApiRequestImage 
          .post('/media/authorize/sellers/person',body)
          .then((res) => {
              console.log(res)
              if (res.data.err) {
          ...
          setError('تصویر کارت ملی و تاییدیه آن اجباری است')
      }
    }
    ...
    <div>
        ...
        <div  className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="px-8 py-6 mt-4 text-left bg-white shadow-lg my-16">
                <h3 className="text-2xl font-bold text-center">فروشنده حقیقی</h3>
                {/* <form > */}
                    ...
                    <div className="px-8 py-6 mt-4 text-left ">
                            ...
                            <div className="mt-6">
                                <div>
                                    <label className="text-right block" htmlFor="email">تصویر کارت ملی *</label>
                                ...
                                <div className="mt-6">
                                        <label className="text-right block" htmlFor="email">تصویر تاییدیه متنی کارت ملی *</label>
                                ...
                                <div className="mt-6">
                                        <label className="text-right block" htmlFor="email">تصویر جواز کسب</label>

  ...
  <div>
    ...
    <div className="relative z-40 lg:hidden" role="dialog" aria-modal="true">
      ...
      <div className="fixed inset-0 z-40 flex">
        ...
        <div className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto scrollbar-thumb-beh-orange scrollbar-thin scrollbar-track-beh-gray bg-white py-4 pb-12 shadow-xl">
